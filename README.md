...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/merge-args-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15387&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/merge-args-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `merge-args` can be installed with:

```
conda install merge-args
```

It is possible to list all of the versions of `merge-args` available on your platform with:
